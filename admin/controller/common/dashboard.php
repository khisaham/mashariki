...
class ControllerCommonDashboard extends Controller {
 ...
 $this->data['matters'] = $this->url->link('matters/view', 'token=' . $this->session->data['token'], true);
        $this->data['total_customers'] = number_format($this->model_report_customer->getTotalCustomers($filter_data), 0, $this->language->get('decimal_point'), $this->language->get('thousand_point'));
            ...
            $this->data['total_cash'] = number_format($this->model_report_customer->getTotalCash(), 0, $this->language->get('decimal_point'), $this->language->get('thousand_point'));
            $this->data['total_matters'] = number_format($this->model_report_customer->getTotalMatters(), 0, $this->language->get('decimal_point'), $this->language->get('thousand_point'));
