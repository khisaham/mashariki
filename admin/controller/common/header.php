    ...
    public function index() {
        ...
        if ($this->user->isLogged() && isset($this->request->get['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            $this->data['dashboard'] = $this->url->link('common/dashboard', 'token=' . $this->session->data['token']);
             ...
             $this->data['cash'] = $this->url->link('common/cash', 'token=' . $this->session->data['token']);
            ...
            $this->data['customer'] = $this->url->link('billing/customer', 'token=' . $this->session->data['token'], true);
             ...
             $this->data['matters'] = $this->url->link('matters/view', 'token=' . $this->session->data['token'], true);

               $this->data['jobentry'] = $this->url->link('matters/new_job/form', 'token=' . $this->session->data['token'], true);

              $this->data['uploads'] = $this->url->link('matters/uploads', 'token=' . $this->session->data['token'], true);
            ...
            $this->data['chart_of_accounts'] = $this->url->link('report/chart_of_accounts', 'token=' . $this->session->data['token'], true);
              ...
              $this->data['chart_and_graphs'] = $this->url->link('report/charts_and_graphs', 'token=' . $this->session->data['token'], true);
