...
$total = $link->query("SELECT sum(jobamountpayed) as 'total' FROM job ");
$t_total[] = mysqli_fetch_array($total);
$total_total = $t_total['0']['total'];

$result = $link->query("SELECT distinct jobassignment, sum(jobamountpayed)as 'ctb' from job group by jobassignment");
...
$('#container2').highcharts({
        ...
        title: {
            text: '<b>Pie chart of Person per amount<br><a href="charts.php">View Status Wise</a></b>'
        },
        tooltip: {
