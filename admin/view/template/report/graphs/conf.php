...
if (stripos($_SERVER['SCRIPT_NAME'], 'apps/phpgrid-custom-crm')) {
    ...
    define('PHPGRID_DB_PASSWORD', '@OPENsystems'); // database password
    define('PHPGRID_DB_NAME', 'mamboleo_mis_database'); // database name
	...
	define('PHPGRID_DB_USERNAME', 'rushema');     // database user name
	define('PHPGRID_DB_PASSWORD', 'rushema'); // database password
	define('PHPGRID_DB_NAME', 'mamboleo_mis_database'); // database name
	define('PHPGRID_DB_TYPE', 'mysql');  // database type
	define('PHPGRID_DB_CHARSET','utf8'); // ex: utf8(for mysql),AL32UTF8 (for oracle), leave blank to use the default charset
}
...
/**********************************/
 @$link = mysqli_connect(PHPGRID_DB_HOSTNAME,PHPGRID_DB_USERNAME,PHPGRID_DB_PASSWORD,PHPGRID_DB_NAME);
?>
