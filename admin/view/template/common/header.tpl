...
<html dir="<?php echo $direction; ?>" lang="<?php echo $language_code; ?>">
  ...
  <body>
    <?php if ($logged) { ?>
    <header id="header">
      <img id="button-menu" src="" style="height:30px;" />
      <ul class="nav pull-right">
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope fa-5x fa-border icon-grey badge"></i></a>
          <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="http://www.masharikiregistry.com" target="_blank">Mashariki Registry</a></li>
            <li><a href="http://www.masharikiregistry.com" target="_blank"><?php echo $text_documentation; ?></a></li>
            <li><a href="http://www.masharikiregistry.com" target="_blank"><?php echo $text_forum; ?></a></li>
          </ul>
        </li>
    ...
    <nav id="column-left" role="navigation">
      <ul id="menu">
        ...
        <li><a href="<?php echo $cash; ?>"><i class="fa fa-money fa-fw"></i> <span><?php echo $text_cash_hand; ?></span></a></li>
        <li><a class="parent"><i class="fa fa-usd fa-fw"></i> <span><?php echo $text_matters; ?></span></a>
                    <ul>
            <li><a href="<?php echo $matters; ?>"><span><?php echo $text_view_matters; ?></span></a></li>
             <li><a href="<?php echo $jobentry; ?>"><span><?php echo $text_new_job_entry; ?></span></a></li>
            <li><a href="<?php echo $uploads; ?>"><span><?php echo $text_bulk_upload; ?></span></a></li>
  ...
  <!--       <li><a class="parent"><i class="fa fa-newspaper-o fa-fw"></i> <span><?php echo $text_content; ?></span></a>
          ...
          <ul>
            <li><a class="parent"><span><?php echo $text_accounting; ?></span></a>
              <ul>
                ...
                <li><a href="<?php echo $chart_and_graphs; ?>"><span><?php echo $text_chart_and_graphs; ?></span></a></li>
              </ul>
            </li>
    ...
    <?php } ?>
    <div id="content" class="container-fluid" data-vide-bg="video/Ipad">