  ...
  <div class="row dashboard-stats">
    ...
    <div class="col-xs-12 col-md-3 alternate">
      <div class="tile">
       ...
       <div class="col-xs-12 col-md-3 primary">
      <div class="tile">
        <div class="heading"><?php echo $text_cash_hand; ?></div>
        <div class="body">
          <i class="fa fa-dollar"></i>
          <div class="pull-right"><?php echo $total_cash; ?></div>
        </div>
        <div class="footer">
          <a href="<?php echo $cash_hand; ?>"><?php echo $text_view_more; ?></a>
          <div class="pull-right"><a href="<?php echo $cash_hand; ?>" title="<?php echo $text_view_more; ?>" data-toggle="tooltip"><i class="fa fa-external-link"></i></a></div>
        </div>
      </div>
    </div>
    <div class="col-xs-12 col-md-3 alternate">
    ...
    <div class="col-xs-12 col-md-3 alternate">
      <div class="tile">
        ...
        <div class="col-xs-12 col-md-3 primary">
      <div class="tile">
        <div class="heading"><?php echo $text_matters; ?></div>
        <div class="body">
          <i class="fa fa-refresh"></i>
          <div class="pull-right"><?php echo $total_matters; ?></div>
        </div>
        <div class="footer">
          <a href="<?php echo $matters; ?>"><?php echo $text_view_more; ?></a>
          <div class="pull-right"><a href="<?php echo $matters; ?>" title="<?php echo $text_view_more; ?>" data-toggle="tooltip"><i class="fa fa-external-link"></i></a></div>
        </div>
      </div>
    </div>
  </div>
