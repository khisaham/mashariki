...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="pull-right">
      ...
      <button type="button" title="<?php echo $button_delete; ?>" data-toggle="tooltip" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-tax-class').submit() : false;"><i class="fa fa-trash"></i></button>
    </div>
    <h1 class="panel-title"><i class="fa fa-list fa-lg"></i> <?php echo $heading_title; ?></h1>
  </div>
  <div class="panel-body">
    <form method="post" action="<?php echo $delete; ?>" id="form-tax-class">
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr>
            <td class="text-center"><?php if (in_array($tax_class['tax_class_id'], $selected)) { ?>
              ...
              <?php } ?></td>
            <td class="text-left"><?php echo $tax_class['name']; ?></td>
            <td class="text-right"><a href="<?php echo $tax_class['edit']; ?>" title="<?php echo $button_edit; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
