    ...
    <form method="post" action="<?php echo $delete; ?>" id="form-customer">
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            <?php
            foreach($matters as $rows0): ?>
<tr>
  <td>#</td>
  <td><?php echo $rows0['matterid']; ?></td>
  <td><?php echo $rows0['date_due']; ?></td>
   <td><?php echo $rows0['assigned_to']; ?></td>
  <td><?php echo $rows0['disbursementamount']; ?></td>
        <td class="text-right">
              <a href="<?php echo $rows0['view']; ?>" target="_blank" title="<?php echo $button_view; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs"><i class="fa fa-clipboard"></i></a>
              <a href="<?php echo $rows0['edit']; ?>" title="<?php echo $button_edit; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
            </td>
</tr>
          <?php endforeach; ?>
          </tbody>
