...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form method="post" action="<?php echo $action; ?>" id="form-recurring" class="form-horizontal">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#tab-general" data-toggle="tab"><?php echo $tab_general; ?></a></li>
       
        <li class="disabled"><a href="#tab-payment-method" data-toggle="tab"><?php echo $tab_payment_method; ?></a></li> <li class="disabled"><a href="#tab-item" data-toggle="tab"><?php echo $tab_item; ?></a></li>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab-general">
          <div class="form-group">
            <label class="required col-sm-2 control-label" for="input-customer"><?php echo $entry_matterid; ?></label>
            <div class="col-sm-10">
              <input type="text" name="matterid" value="<?php echo $matterid; ?>" id="input-customer" class="form-control" placeholder="<?php echo $entry_matterid; ?>" required autofocus />
              <input type="hidden" name="matter_id" value="<?php echo $matter_id; ?>" />
            </div>
          </div>
              <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_law_firm; ?></label>
            <div class="col-sm-10">
              <select name="status" id="input-status" class="form-control">
          <?php
          foreach($law_firms as $rows_law_firms): 
          ?>
          <option><?php echo $rows_law_firms['firm']; ?></option>
        <?php endforeach; ?>
              </select>
            </div>
          </div>
              <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_associate; ?></label>
            <div class="col-sm-10">
              <select name="status" id="input-status" class="form-control">
                      <?php
          foreach($associates as $row_associates): 
          ?>
          <option><?php echo $row_associates['name']; ?></option>
        <?php endforeach; ?>
              </select>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-comment"><?php echo $entry_instructions; ?></label>
            <div class="col-sm-10">
              <textarea name="comment" id="input-comment" class="form-control" rows="5" placeholder="<?php echo $entry_comment; ?>"><?php echo $entry_instructions; ?></textarea>
            </div>
          </div>
                 <div class="form-group">
...
$(document).ready(function () {
	...
	$('#button-forward-step-1').click(function () {
		$.ajax({
			url: 'index.php?load=matters/new_job/validate_step_1&token=<?php echo $token; ?>',
			...
			success: function (json) {
				if (json['success']) {
					...
					if (json['matterid']) {
						$('#tab-general input[name=\'matterid\']').after('<span class="text-danger">' + json['matterid'] + '</span>');
					}
