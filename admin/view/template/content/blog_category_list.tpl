    ...
    <form method="post" action="<?php echo $delete; ?>" id="form-status">
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr>
            <td class="text-center"><?php if (in_array($blog_category['blog_category_id'], $selected)) { ?>
              ...
              <?php } ?></td>
            <td class="text-left"><?php echo $blog_category['name']; ?></td>
            <td class="text-right"><?php echo $blog_category['sort_order']; ?></td>
            <td class="text-right"><?php echo $blog_category['status']; ?></td>
            <td class="text-right"><a href="<?php echo $blog_category['edit']; ?>" title="<?php echo $button_edit; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
