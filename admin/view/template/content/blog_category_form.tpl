          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                ...
                <input type="text" name="description[<?php echo $language['language_id']; ?>][name]" value="<?php echo !empty($description[$language['language_id']]['name']) ? $description[$language['language_id']]['name'] : ''; ?>" id="input-name-<?php echo $language['language_id']; ?>" class="form-control" placeholder="<?php echo $entry_name; ?>" required />
              </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <select name="parent_id" id="input-parent" class="form-control">
            ...
            <option value="<?php echo $blog_category['blog_category_id']; ?>"<?php echo $blog_category['blog_category_id'] == $parent_id ? ' selected="selected"' : ''; ?>><?php echo $blog_category['name']; ?></option>
            <?php } ?>
          </select>
        </div>
      </div>
