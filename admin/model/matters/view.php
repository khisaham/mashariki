...
class ModelMattersView extends Model {
    ...
    public function editView($customer_id, $data) {
    ...
    public function deleteView($customer_id) {
    ...
    public function getView($customer_id) {
