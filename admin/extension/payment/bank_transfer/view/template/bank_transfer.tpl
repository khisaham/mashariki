...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form method="post" action="<?php echo $action; ?>" id="form-bank-transfer" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="input-group">
            ...
            <textarea name="bank_transfer_details[<?php echo $language['language_id']; ?>]" id="input-details-<?php echo $language['language_id']; ?>" class="form-control" placeholder="<?php echo $entry_details; ?>" rows="5"><?php echo !empty($bank_transfer_details[$language['language_id']]) ? $bank_transfer_details[$language['language_id']] : ''; ?></textarea>
          </div>
        </div>
      </div>
      <?php } ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10"><select name="bank_transfer_status" id="input-status" class="form-control">
            <option value="1"<?php echo $bank_transfer_status ? ' selected="selected"' : ''; ?>><?php echo $text_enabled; ?></option>
            <option value="0"<?php echo $bank_transfer_status ? '' : ' selected="selected"'; ?>><?php echo $text_disabled; ?></option>
          </select>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" name="bank_transfer_sort_order" value="<?php echo $bank_transfer_sort_order; ?>" id="input-sort-order" class="form-control" placeholder="<?php echo $entry_sort_order; ?>" />
        </div>
      </div>
    </form>
  </div>
